...
Unofficial python script to get a XDR or Cisco Workflows appliance to register with the base64 string, without needing OVA string support for the cloud init process.
